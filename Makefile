...
.PHONY: bitstream include sim formal lint gls icesugar_gls program clean
...
formal: build/formal/PASS

build/formal/PASS: $(RTL_SRC)
	sby -d build/formal -f formal.sby

lint: $(wildcard rtl/*.sv) $(RTL_SRC)
